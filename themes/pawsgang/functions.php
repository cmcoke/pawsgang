...
function pawsgang_scripts()
{
  ...
  wp_enqueue_style('pawsgang-main', get_template_directory_uri() . '/css/main.min.css');
  ...
  wp_enqueue_script('bootstrap-script', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js', array('jquery'));
